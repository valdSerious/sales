...
export class WebhooksService {
    ...
    constructor(
        ...
        this.webhooks$ = new Observable(observer => this._dataObserver = observer).share();
        this._dataStore = [];
    }
    ...
    getEvents() {
        return this._data.get('v3/webhooks/log').map(response => response.json().data).toPromise();
    }
